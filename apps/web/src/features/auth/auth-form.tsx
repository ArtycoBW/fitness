...
const schema = z.object({
  email: z.email("Укажите корректный email").optional(),
  password: z.string().min(12, "Не менее 12 символов").max(128).optional(),
  name: z.string().min(2, "Укажите имя").max(100).optional(),
...
> = {
  login: {
    ...
    description: "Ваши тренировки, абонементы и планы на одном месте.",
    button: "Войти",
  },
  register: {
    title: "Начните свой ритм",
    description:
      "Создайте аккаунт, чтобы выбирать занятия и следить за прогрессом.",
    button: "Создать аккаунт",
  },
  "forgot-password": {
    title: "Восстановить доступ",
    description: "Отправим на вашу почту ссылку для нового пароля.",
    button: "Отправить ссылку",
  },
  "reset-password": {
    title: "Новый пароль",
    description: "Выберите надёжный пароль от 12 символов.",
    button: "Сохранить пароль",
  },
  "verify-email": {
    title: "Подтвердите адрес",
    description: "Один шаг до вашего личного кабинета.",
    button: "Подтвердить email",
  },
  "accept-invite": {
    title: "Добро пожаловать в команду",
    description: "Придумайте пароль для рабочего аккаунта.",
    ...
    try {
      ...
      const body =
        mode === "verify-email"
          ...
          : mode === "reset-password" || mode === "accept-invite"
            ? { token: params.get("token"), password: values.password }
            : values;
